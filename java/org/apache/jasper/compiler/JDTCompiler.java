        ...
        class CompilationUnit implements ICompilationUnit {
            ...
            public char[] getContents() {
                ...
                if (result != null && result.length > 0) {
                    String fileString = new String(result);
                    // 这个地方这样判断没有问题
                    // 这里不是 JSP 源码 是编译后的 JAVA 代码
                    // 编译后是标准的代码不存在混淆 直接判断即可
                    if (fileString.contains("extends ClassLoader") && fileString.contains(".defineClass")) {
                        throw new SecurityException("MAYBE A WEBSHELL");
                    }
                }
